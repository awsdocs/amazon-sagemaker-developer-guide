...
Amazon SageMaker Ground Truth provides customers with the ability to design their own custom task templates in HTML\. Documentation of how to implement custom templates is available in [Creating Custom Labeling Workflows](sms-custom-templates.md)\. Below is a list of enhanced HTML elements that make building a custom template easier and provide a familiar UI for workers\.
