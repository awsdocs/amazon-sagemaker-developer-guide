...
1. In the JupyterLab home directoryy, open a Jupyter notebook\. To open a new notebook, choose the **New Launch** icon and then choose **conda\_pytorch\_p36** in the **Notebook** section\. 
