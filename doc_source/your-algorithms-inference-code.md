...
**Note**  
Amazon SageMaker does not currently run this health check continuously\. This is intended to prevent an unstable container going into service against an endpoint at startup\.