...
+ [Build Models](build-model.md)
   + [Use Amazon SageMaker Notebooks](notebooks.md)
      + [How Are These Notebooks Different from Instance-based Amazon SageMaker Notebooks?](notebooks-comparison.md)
      + [Get Started](notebooks-get-started.md)
      + [Create a Notebook](notebooks-create-notebook.md)
      + [Run and Manage Amazon SageMaker Studio Notebooks](notebooks-run-and-manage.md)
         + [Change a Notebook's Environment](notebooks-run-and-manage-change-environment.md)
      + [Share Amazon SageMaker Studio Notebooks](notebooks-sharing.md)
         + [Use Sample Notebooks](notebooks-samples.md)
         + [View Personal Storage](notebooks-personal-storage.md)
...
+ [Deploy Models](deploy-model.md)
   ...
   + [Deployment Best Practices](best-pratices.md)
