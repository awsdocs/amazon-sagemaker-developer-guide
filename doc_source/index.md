...
+ [Use Amazon SageMaker Autopilot to automate model development](autopilot-automate-model-development.md)
...
+ [Train Models](train-model.md)
   ...
   + [Amazon SageMaker Debugger](train-debugger.md)
      ...
      + [How to Use Built-in Rules for Model Analysis](use-debugger-built-in-rules.md)
         ...
         + [Use smdebug Python library with the Amazon SageMaker Python SDK to Create a Built-in Rule](debugger-built-in-rules-python-sdk.md)
      ...
      + [How to Use Custom Rules](debugger-custom-rules.md)
         ...
         + [Use smdebug Python library with the Amazon SageMaker Python SDK to Create a Custom Rule](debugger-custom-rules-python-sdk.md)
