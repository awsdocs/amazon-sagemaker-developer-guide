...
+ [Get Started with Amazon SageMaker](gs.md)
   ...
   + [Onboard to Amazon SageMaker Domain](gs-studio-onboard.md)
      ...
      + [Onboard to Amazon SageMaker Domain Using IAM Identity Center](onboard-sso-users.md)
         + [Set Up IAM Identity Center for use with Amazon SageMaker Domain](onboard-sso-setup.md)
   ...
   + [SageMaker JumpStart](studio-jumpstart.md)
      + [Solution Templates](jumpstart-solutions.md)
         + [Launch a Solution](jumpstart-solutions-launch.md)
      + [Models](jumpstart-models.md)
         + [Deploy a Model](jumpstart-deploy.md)
         + [Fine-Tune a Model](jumpstart-fine-tune.md)
         + [Share Models](jumpstart-share-models.md)
...
+ [Amazon SageMaker Machine Learning Environments](machine-learning-environments.md)
   + [Amazon SageMaker Domain](sm-domain.md)
      ...
      + [Collaborate with shared spaces](domain-space.md)
         + [Create a shared space](domain-space-create.md)
         + [List and Describe shared spaces](domain-space-list.md)
         + [Edit a shared space](domain-space-edit.md)
         + [Delete a shared space](domain-space-delete.md)
   ...
   + [Amazon SageMaker Canvas](canvas.md)
      ...
      + [Importing data in Amazon SageMaker Canvas](canvas-importing-data.md)
         ...
         + [Use sample datasets](canvas-sample-datasets.md)
      + [Build a model](canvas-build-model.md)
         + [Explore and analyze your data](canvas-explore-data.md)
            + [Explore your data using visualization techniques](canvas-explore-data-visualization.md)
            + [Explore your data using analytics](canvas-explore-data-analytics.md)
         + [Prepare data with advanced transformations](canvas-prepare-data.md)
   ...
   + [Amazon SageMaker geospatial capabilities](geospatial.md)
      + [Getting Started with Amazon SageMaker geospatial capabilities](geospatial-getting-started.md)
         + [Launch a SageMaker Studio notebook with a SageMaker geospatial image](geospatial-launch-notebook.md)
   ...
   + [RStudio on Amazon SageMaker](rstudio.md)
      + [Manage RStudio on Amazon SageMaker](rstudio-manage.md)
         ...
         + [Bring your own image to RStudio on SageMaker](rstudio-byoi.md)
            + [Prerequisites](rstudio-byoi-prerequisites.md)
            + [Custom RStudio image specifications](rstudio-byoi-specs.md)
            + [Create a custom RStudio image](rstudio-byoi-create.md)
            + [Attach a custom SageMaker image](rstudio-byoi-attach.md)
            + [Launch a custom SageMaker image in RStudio](rstudio-byoi-launch.md)
            + [Clean up image resources](rstudio-byoi-sdk-cleanup.md)
...
+ [Automate model development with Amazon SageMaker Autopilot](autopilot-automate-model-development.md)
   ...
   + [Amazon SageMaker Autopilot model deployment and prediction](autopilot-deploy-models.md)
      + [Real-time inferencing](autopilot-deploy-models-realtime.md)
      + [Batch inferencing](autopilot-deploy-models-batch.md)
   ...
   + [Models generated by Amazon SageMaker Autopilot](autopilot-models.md)
      + [View model details](autopilot-models-details.md)
      + [View an Autopilot Model Performance Report](autopilot-model-insights.md)
...
+ [Label Data](data-label.md)
   + [Use Amazon SageMaker Ground Truth to Label Data](sms.md)
      ...
      + [Use Ground Truth to Label 3D Point Clouds](sms-point-cloud.md)
         + [3D Point Cloud Task types](sms-point-cloud-task-types.md)
            ...
            + [3D-2D Point Cloud Object Tracking](sms-point-cloud-3d-2d-object-tracking.md)
      ...
      + [Ground Truth Security and Permissions](sms-security-general.md)
         ...
         + [Using Amazon SageMaker Ground Truth in an Amazon Virtual Private Cloud](sms-vpc.md)
            + [Run an Amazon SageMaker Ground Truth Labeling Job in an Amazon Virtual Private Cloud](samurai-vpc-labeling-job.md)
            + [Use Amazon VPC Mode from a Private Worker Portal](samurai-vpc-worker-portal.md)
               + [Using the SageMaker console to manage a VPC config](samurai-vpc-workforce-console.md)
               + [Using the SageMaker AWS API to manage a VPC config](samurai-vpc-workforce-cli.md)
   ...
   + [Use Amazon SageMaker Ground Truth Synthetic Data to Generate and Label Data](gts.md)
      + [Getting Started with Amazon SageMaker Ground Truth Synthetic Data](gts-getting-started.md)
         + [Set Up Amazon SageMaker Ground Truth Synthetic Data Prerequisites](gts-getting-started-prerequisites.md)
         + [Core Components of Amazon SageMaker Ground Truth Synthetic Data](gts-getting-started-core-components.md)
         + [Request a Project](gts-request-project.md)
      + [Share Data from Your Amazon S3 Bucket](gts-share-data.md)
      + [Project Portal](gts-project-portal.md)
      + [Review Batches](gts-review-batches.md)
      + [Accept or Reject Batches](gts-accept-reject-batch.md)
...
+ [Prepare and Analyze Datasets](data-prep.md)
   ...
   + [Prepare Data at Scale with Studio Notebooks](studio-notebooks-at-scale.md)
      + [Prepare Data using Amazon EMR](studio-notebooks-emr-cluster.md)
         ...
         + [Connect to a cluster from Studio](studio-notebooks-emr-cluster-connect.md)
            + [Connect to an Amazon EMR Cluster from Studio Using Runtime IAM Roles](studio-notebooks-emr-cluster-rbac.md)
               + [Set Up Studio to Use Runtime IAM Roles](studio-notebooks-emr-cluster-iam.md)
      ...
      + [Prepare Data using AWS Glue Interactive Sessions](studio-notebooks-glue.md)
         + [Get Started with AWS Glue Interactive Sessions](getting-started-glue-sm.md)
         + [AWS Glue Interactive Session Pricing](glue-sm-pricing.md)
...
+ [Create, Store, and Share Features with Amazon SageMaker Feature Store](feature-store.md)
   ...
   + [Add Features to a Feature Group](feature-store-update-feature-group.md)
      ...
      + [Use Amazon SageMaker Built-in Algorithms or Pre-trained Models](algos.md)
         ...
         + [Built-in SageMaker Algorithms for Tabular Data](algorithms-tabular.md)
            + [AutoGluon-Tabular](autogluon-tabular.md)
               + [How AutoGluon-Tabular works](autogluon-tabular-HowItWorks.md)
               + [AutoGluon-Tabular hyperparameters](autogluon-tabular-hyperparameters.md)
               + [Tuning an AutoGluon-Tabular model](autogluon-tabular-tuning.md)
            + [CatBoost](catboost.md)
               + [How CatBoost Works](catboost-HowItWorks.md)
               + [CatBoost hyperparameters](catboost-hyperparameters.md)
               + [Tune a CatBoost model](catboost-tuning.md)
            ...
            + [LightGBM](lightgbm.md)
               + [How LightGBM works](lightgbm-HowItWorks.md)
               + [LightGBM hyperparameters](lightgbm-hyperparameters.md)
               + [Tune a LightGBM model](lightgbm-tuning.md)
            ...
            + [TabTransformer](tabtransformer.md)
               + [How TabTransformer works](tabtransformer-HowItWorks.md)
               + [TabTransformer hyperparameters](tabtransformer-hyperparameters.md)
               + [Tune a TabTransformer model](tabtransformer-tuning.md)
         ...
         + [Built-in SageMaker Algorithms for Text Data](algorithms-text.md)
            ...
            + [Text Classification - TensorFlow](text-classification-tensorflow.md)
         ...
         + [Built-in SageMaker Algorithms for Computer Vision](algorithms-vision.md)
            ...
            + [Image Classification - TensorFlow](image-classification-tensorflow.md)
            ...
            + [Object Detection - TensorFlow](object-detection-tensorflow.md)
...
+ [Deploy Models for Inference](deploy-model.md)
   ...
   + [Real-time inference](realtime-endpoints.md)
      ...
      + [Online Explainability with SageMaker Clarify](clarify-online-explainability.md)
         + [Pre-check the model container](clarify-online-explainability-precheck.md)
         + [Configure and create an endpoint](clarify-online-explainability-create-endpoint.md)
         + [Invoke the endpoint](clarify-online-explainability-invoke-endpoint.md)
         + [Code examples: SDK for Python](clarify-online-explainability-examples.md)
         + [Troubleshooting guide](clarify-online-explainability-troubleshooting.md)
   ...
   + [Monitor models for data and model quality, bias, and explainability](model-monitor.md)
      + [Capture data](model-monitor-data-capture.md)
         + [Capture data from real-time endpoint](model-monitor-data-capture-endpoint.md)
         + [Capture data from batch transform job](model-monitor-data-capture-batch.md)
   ...
   + [Serverless Inference](serverless-endpoints.md)
   ...
   + [Shadow tests](shadow-tests.md)
      + [Create a shadow test](shadow-tests-create.md)
      + [View, monitor, and edit shadow tests](shadow-tests-view-monitor-edit.md)
      + [Complete a shadow test](shadow-tests-complete.md)
      + [Best Practices](shadow-tests-best-practices.md)
   + [Container SSM access](ssm-access.md)
   ...
   + [Deploy models at the edge with SageMaker Edge Manager](edge.md)
      ...
      + [The Edge Manager Agent](edge-device-fleet-about.md)
         + [Download and Set Up the Edge Manager Agent Manually](edge-device-fleet-manual.md)
         + [Deploy the Model Package and Edge Manager Agent with AWS IoT Greengrass](edge-greengrass.md)
            + [Prerequisites](edge-greengrass-prerequisites.md)
            + [Create the AWS IoT Greengrass V2 Components](edge-greengrass-custom-component.md)
            + [Deploy the components to your device](edge-greengrass-deploy-components.md)
         + [Deploy the Model Package Directly with SageMaker Edge Manager Deployment API](edge-deployment-plan-api.md)
   ...
   + [Supported features](model-deploy-feature-matrix.md)
   + [Resources](inference-resources.md)
...
+ [Using Docker containers with SageMaker](docker-containers.md)
   ...
   + [Use Pre-built SageMaker Docker images](docker-containers-prebuilt.md)
      ...
      + [Docker Registry Paths and Example Code](sagemaker-algo-docker-registry-paths.md)
         ...
         + [Docker Registry Paths and Example Code for Asia Pacific (Jakarta) (ap-southeast-3)](ecr-ap-southeast-3.md)
   ...
   + [Adapting your own Docker container to work with SageMaker](docker-containers-adapt-your-own.md)
      ...
      + [Adapting your own training container](adapt-training-container.md)
         + [Adapt your training job to access images in a private Docker registry](docker-containers-adapt-your-own-private-registry.md)
            + [Use a SageMaker estimator to run a training job](docker-containers-adapt-your-own-private-registry-estimator.md)
            + [Use a Docker registry that requires authentication for training](docker-containers-adapt-your-own-private-registry-authentication.md)
...
+ [SageMaker Workflows](workflows.md)
   ...
   + [Kubernetes Orchestration](kubernetes-workflows.md)
      + [SageMaker Operators for Kubernetes](kubernetes-sagemaker-operators.md)
         + [Latest SageMaker Operators for Kubernetes](kubernetes-sagemaker-operators-ack.md)
         + [Old SageMaker Operators for Kubernetes](kubernetes-sagemaker-operators-end-of-support.md)
   ...
   + [Notebook-based Workflows](notebook-auto-run.md)
      + [Install policies and permissions](scheduled-notebook-policies.md)
      + [Create and manage your scheduled notebook jobs](create-manage-notebook-auto-run.md)
         + [Schedule a notebook job](create-notebook-auto-run.md)
            + [Additional options](create-notebook-auto-execution-advanced.md)
            + [Connect to an Amazon EMR cluster](scheduled-notebook-connect-emr.md)
            + [Parameterize your notebook](notebook-auto-run-troubleshoot-override.md)
         + [View notebook jobs](view-notebook-jobs.md)
         + [View notebook job definitions](view-def-detail-notebook-auto-run.md)
      + [Troubleshooting guide](notebook-auto-run-troubleshoot.md)
      + [Constraints and considerations](notebook-auto-run-constraints.md)
      + [Pricing for scheduled notebook jobs](notebook-auto-run-pricing.md)
...
+ [Amazon SageMaker Model Governance](governance.md)
   + [Amazon SageMaker Model Cards](model-cards.md)
   ...
   + [Amazon SageMaker Model Dashboard](model-dashboard.md)
      + [View Model Monitor schedules and alerts](model-dashboard-schedule.md)
         + [View and edit alerts](model-dashboard-alerts.md)
      + [View a model lineage graph](model-dashboard-lineage.md)
         + [Introduction to entities](model-dashboard-lineage-intro-entities.md)
      + [View Endpoint Status](model-dashboard-endpoints.md)
      + [Model Dashboard FAQ](model-dashboard-faqs.md)
