...
+ [Deploy Models for Inference](deploy-model.md)
   + [Amazon SageMaker Inference Recommender](inference-recommender.md)
      + [Pricing](inference-recommender-pricing.md)
   ...
   + [Deploy multi-container endpoints](multi-container-endpoints.md)
   ...
   + [Compile and Deploy Models with Neo](neo.md)
...
+ [Availability Zones](instance-types-az.md)
