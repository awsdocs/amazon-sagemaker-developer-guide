...
Replace *fx\_version* while ensuring that model was compiled for same version previously with one of the following supported versions:
+ For `cpu` and `gpu`: `1.4.1, 1.5.0, 1.6.0, 1.7.0, 1.8.0, 1.9.0, 1.10.0, 1.11.0, 1.12.0, 1.13.0, 1.14.0, 1.15.0`
+ For `inf`: `1.15.0`

Replace *instance\_type* with `cpu`, `gpu`, or `inf`\.
