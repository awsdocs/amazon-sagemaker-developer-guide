...
| Use case  | Solution name  | Description  | Get started  | 
| --- | --- | --- | --- | 
| Computer vision  | Product defect detection | Identify defective regions in product images by training an [object detection model](https://arxiv.org/abs/1506.01497)\. |  [GitHub »](https://github.com/awslabs/sagemaker-defect-detection)  | 
