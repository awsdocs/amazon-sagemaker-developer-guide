...
| Registry path | Version | Job types \(image scope\) | Processor types | Python versions | 
| --- | --- | --- | --- | --- | 
| 763104351884\.dkr\.ecr\.eu\-west\-1\.amazonaws\.com/tensorflow\-training:<tag> | 2\.9\.1 | training | CPU, GPU | py39 | 
...
| 685385470294\.dkr\.ecr\.eu\-west\-1\.amazonaws\.com/xgboost:<tag> | 1 | 0\.72 | inference, training | 
