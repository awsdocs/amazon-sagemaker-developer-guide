...
textract = boto3.client('textract', aws-region)
...
response = client.start_human_loop(
    HumanLoopName='human_loop_name',
    FlowDefinitionArn='arn:aws:sagemaker:aws-region:xyz:flow-definition/hl_name',
    HumanLoopInput={
...
$ aws sagemaker-a2i-runtime start-human-loop
        --flow-definition-arn 'arn:aws:sagemaker:aws-region:xyz:flow-definition/hl_name' \
