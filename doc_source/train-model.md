...
+ For guidance on metrics used to detect model post\-processing bias, see [Detect post\-training data and model bias](clarify-detect-post-training-bias.md)\. 
...
+ [Detect post\-training data and model bias](clarify-detect-post-training-bias.md)
