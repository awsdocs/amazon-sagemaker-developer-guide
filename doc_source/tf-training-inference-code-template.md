...
Your TensorFlow training script must be a Python 2\.7 source file\. The current supported TensorFlow version is 1\.4\.0\. This training/inference script must contain the following functions:
