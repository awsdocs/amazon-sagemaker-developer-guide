# Design Considerations<a name="automatic-model-tuning-considerations"></a>
...
## Use Logarithmic Scales for Hyperparameters<a name="automatic-model-tuning-log-scales"></a>
