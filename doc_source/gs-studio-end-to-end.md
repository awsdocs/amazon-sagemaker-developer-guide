...
1. Sign in to Studio\. For users in IAM Identity Center, sign in using the URL from your invitation email\. For IAM users, follow these steps\.
   ...
   1. Choose **Studio** in the left navigation pane\.

   1. Under **Get Started**, select your domain and user profile\.
...
1. Follow the notebook to learn about Studio's main features\.
