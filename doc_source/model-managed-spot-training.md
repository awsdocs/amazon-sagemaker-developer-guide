...
Amazon SageMaker automatic model tuning, also known as hyperparameter tuning, can use managed spot training\. For more information on automatic model training, see [Perform Automatic Model Tuning](automatic-model-tuning.md)\.
