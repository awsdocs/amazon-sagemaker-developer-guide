...
| steps | The number of steps this rule analyzes\. You typically want to check only the first few iterations\. **Optional** Valid values: Float Default value: `10`  | 
