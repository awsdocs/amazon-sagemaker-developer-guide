# Set Up Amazon SageMaker Ground Truth Synthetic Data Prerequisites<a name="gts-getting-started-prerequisites"></a>

To use Ground Truth synthetic data, you need an AWS account\. If you already have an AWS account, skip this step\.
