...
|  [CreateTransformJob](API_CreateTransformJob.md)  |  `sagemaker:CreateTransformJob` `iam:PassRole` `kms:CreateGrant` \(required only if you specify a `KmsKeyId`\)  |  `arn:aws:sagemaker:region:account-id:transform-job/transformJobName`  | 
