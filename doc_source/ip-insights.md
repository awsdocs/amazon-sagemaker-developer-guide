...
**Topics**
+ [Input/Output Interface](#ip-insights-inputoutput)
+ [EC2 Instance Recommendation](#ip-insights-instances)
...
## Input/Output Interface<a name="ip-insights-inputoutput"></a>
...
### GPU Instances<a name="ip-insights-instances-gpu"></a>
...
### CPU Instances<a name="ip-insights-instances-cpu"></a>
