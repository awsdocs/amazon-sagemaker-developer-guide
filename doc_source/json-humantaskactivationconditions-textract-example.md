...
+ `Sampling` – Use this condition to specify a percentage of forms to send to humans for review, regardless of inference confidence scores\. Use this condition to:
