...
The following is an example of an image classification template that uses the `<crowd-image-classifier>` element\. You can save this template and preview it in any browser\.
