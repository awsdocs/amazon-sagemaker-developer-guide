...
For an example that shows how to do both pre\-processing and post\-processing by using an inference pipeline, see [Deploy Apache Spark pre\-processing and post\-processing with XGBoost for real\-time prediction requests in Amazon SageMaker using Inference Pipelines](https://github.com/awslabs/amazon-sagemaker-examples/blob/master/advanced_functionality/inference_pipeline_sparkml_xgboost_car_evaluation/inference_pipeline_sparkml_xgboost_car_evaluation.ipynb)
