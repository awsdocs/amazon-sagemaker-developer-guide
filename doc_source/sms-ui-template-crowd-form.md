...
The following is an example of an image classification template that uses the `<crowd-form>` element\. You can save this template and preview it in any browser\.
