# Associating Git Repositories with Amazon SageMaker Notebook Instances<a name="nbi-git-repo"></a>
...
+ [Create a Notebook Instance with Associated Git Repositories](#nbi-git-create)
+ [Using Git Repositories in a Notebook Instance](#git-nbi-use)
...
1. To add an AWS CodeCommit repository, choose **AWS CodeCommit**\.

   1. To use an existing AWS CodeCommit repository:
   ...
   1. To create a new AWS CodeCommit repository:

      1. Choose **Create new repository**\.

      1. Enter a name for the repository that you can use in both AWS CodeCommit and Amazon SageMaker\. The name must be 1 to 63 characters\. Valid characters are a\-z, A\-Z, 0\-9, and \- \(hyphen\)\.

      1. Choose **Create repository**\.

1. To add a Git repository hosted somewhere other than AWS CodeCommit :
...
## Create a Notebook Instance with Associated Git Repositories<a name="nbi-git-create"></a>
...
## Using Git Repositories in a Notebook Instance<a name="git-nbi-use"></a>
