...
| PyTorch | 1\.7\.1, 1\.8\.1 | Supports 1\.7\.1, 1\.8\.1 or earlier | Image Classification | One model definition file \(\.pth\) |  | 
| TensorFlow | 1\.15\.0, 2\.4\.2 | Supports 1\.15\.0, 2\.4\.2 or earlier | Image Classification | \*For saved models, one \.pb or one \.pbtxt file and a variables directory that contains variables \*For frozen models, only one \.pb or \.pbtxt file |  | 
