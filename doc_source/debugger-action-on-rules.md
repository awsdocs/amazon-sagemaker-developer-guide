# Action on Amazon SageMaker Debugger Rules<a name="debugger-action-on-rules"></a>

Based on the Debugger rule evaluation status, you can take actions such as stopping training job setting up Amazon CloudWatch Events and AWS Lambda\. See the following topics to learn how to set up Debugger with the products\.

**Topics**
+ [Action on Amazon SageMaker Debugger Rules Using Amazon CloudWatch and AWS Lambda](#debugger-cloudwatch-lambda)
